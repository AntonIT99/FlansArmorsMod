...
public class ModelCivil_Vehicle_Car_2 extends ModelVehicle {
   ...
   public ModelCivil_Vehicle_Car_2() {
      ...
      this.bodyModel[8] = new ModelRendererTurbo(this, 0, 386, this.textureX, this.textureY);
      this.bodyModel[9] = new ModelRendererTurbo(this, 0, 359, this.textureX, this.textureY);
      this.bodyModel[10] = new ModelRendererTurbo(this, 27, 359, this.textureX, this.textureY);
      this.bodyModel[11] = new ModelRendererTurbo(this, 0, 311, this.textureX, this.textureY);
      this.bodyModel[12] = new ModelRendererTurbo(this, 86, 347, this.textureX, this.textureY);
      this.bodyModel[13] = new ModelRendererTurbo(this, 155, 388, this.textureX, this.textureY);
      this.bodyModel[14] = new ModelRendererTurbo(this, 155, 348, this.textureX, this.textureY);
      this.bodyModel[15] = new ModelRendererTurbo(this, 90, 315, this.textureX, this.textureY);
      this.bodyModel[16] = new ModelRendererTurbo(this, 90, 315, this.textureX, this.textureY);
      this.bodyModel[17] = new ModelRendererTurbo(this, 90, 315, this.textureX, this.textureY);
      this.bodyModel[18] = new ModelRendererTurbo(this, 90, 315, this.textureX, this.textureY);
      ...
      this.bodyModel[8].addBox(20.0F, -8.0F, -16.0F, 10, 14, 32, 0.0F);
      this.bodyModel[9].addBox(-34.0F, -8.0F, 14.0F, 10, 9, 2, 0.0F);
      this.bodyModel[10].addBox(-34.0F, -8.0F, -16.0F, 10, 9, 2, 0.0F);
      this.bodyModel[11].addBox(-44.0F, -8.0F, -16.0F, 10, 14, 32, 0.0F);
      this.bodyModel[12].addBox(0.0F, 0.0F, 0.0F, 1, 12, 32, 0.0F);
      this.bodyModel[12].setRotationPoint(5.0F, -18.0F, -16.0F);
      this.bodyModel[12].rotateAngleZ = 0.4363323F;
      this.bodyModel[13].addBox(-45.0F, 2.0F, -17.0F, 6, 4, 34, 0.0F);
      this.bodyModel[14].addBox(25.0F, 2.0F, -17.0F, 6, 4, 34, 0.0F);
      this.bodyModel[15].addBox(0.0F, 0.0F, 0.0F, 21, 3, 1, 0.0F);
      this.bodyModel[15].setRotationPoint(-43.0F, -11.0F, -15.0F);
      this.bodyModel[15].rotateAngleZ = -0.1396263F;
      this.bodyModel[16].addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
      this.bodyModel[16].setRotationPoint(-44.0F, -11.0F, -15.0F);
      this.bodyModel[17].addBox(0.0F, 0.0F, 0.0F, 21, 3, 1, 0.0F);
      this.bodyModel[17].setRotationPoint(-43.0F, -11.0F, 14.0F);
      this.bodyModel[17].rotateAngleZ = -0.1396263F;
      this.bodyModel[18].addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
      this.bodyModel[18].setRotationPoint(-44.0F, -11.0F, 14.0F);
