...
public class ModelBritishBoots extends ModelCustomArmour {
   ...
   public ModelBritishBoots() {
      ...
      this.leftLegModel[0] = new ModelRendererTurbo(this, 25, 49, this.textureX, this.textureY);
      ...
      this.rightLegModel[0] = new ModelRendererTurbo(this, 49, 49, this.textureX, this.textureY);
