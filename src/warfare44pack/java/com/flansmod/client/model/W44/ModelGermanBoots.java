...
public class ModelGermanBoots extends ModelCustomArmour {
   ...
   public ModelGermanBoots() {
      ...
      this.leftLegModel[0] = new ModelRendererTurbo(this, 17, 49, this.textureX, this.textureY);
      ...
      this.rightLegModel[0] = new ModelRendererTurbo(this, 41, 49, this.textureX, this.textureY);
