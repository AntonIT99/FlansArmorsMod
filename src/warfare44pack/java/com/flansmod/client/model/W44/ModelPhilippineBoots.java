...
public class ModelPhilippineBoots extends ModelCustomArmour {
   ...
   public ModelPhilippineBoots() {
      ...
      this.leftLegModel[0] = new ModelRendererTurbo(this, 105, 65, this.textureX, this.textureY);
      ...
      this.rightLegModel[0] = new ModelRendererTurbo(this, 1, 73, this.textureX, this.textureY);
